sap.ui.define([
	...
	return Controller.extend("sap.agro.gestaoprocessos.controller.RecebimentoCana", {
		...
		handleValueHelpTipoCarga: function(oEvent) {
			...
			if (!this._valueHelpDialogTipoCargas) {
				this._valueHelpDialogTipoCargas = sap.ui.xmlfragment(
					"TipoCargas",
					"sap.agro.gestaoprocessos.view.RecebimentoCana.fragments.valuehelps.TipoCargas",
					this
				);
		...
		handleValueHelpCaminhao: function(oEvent) {
			...
			if (!this._valueHelpDialogCaminhoes) {
				this._valueHelpDialogCaminhoes = sap.ui.xmlfragment(
					"Veiculos",
					"sap.agro.gestaoprocessos.view.RecebimentoCana.fragments.valuehelps.Veiculos",
					this
				);
		...
		handleValueHelpMotorista: function(oEvent) {
			...
			if (!this._valueHelpDialogMotoristas) {
				this._valueHelpDialogMotoristas = sap.ui.xmlfragment(
					"Motoristas",
					"sap.agro.gestaoprocessos.view.RecebimentoCana.fragments.valuehelps.Motoristas",
					this
				);
		...
		handleValueHelpNroViagem: function(oEvent) {
			...
			if (!this._valueHelpDialogViagens) {
				this._valueHelpDialogViagens = sap.ui.xmlfragment(
					"Viagens",
					"sap.agro.gestaoprocessos.view.RecebimentoCana.fragments.valuehelps.Viagens",
					this
				);
		...
		_showDetalhesCompartimentoFragment: function() {
			...
			if (!this._DetalhesCompartimentoFragment) {
				this._DetalhesCompartimentoFragment = sap.ui.xmlfragment("DetalhesCompartimento",
					"sap.agro.gestaoprocessos.view.RecebimentoCana.Compartimento.fragments.DetalhesCompartimento",
					this
				);
		...
		_showDetalhesAnaliseFragment: function() {
			...
			if (!this._DetalhesAnaliseFragment) {
				this._DetalhesAnaliseFragment = sap.ui.xmlfragment("DetalhesAnalise",
					"sap.agro.gestaoprocessos.view.RecebimentoCana.Compartimento.fragments.DetalhesAnalise",
					this
				);
		...
		_showDetalhesPesagemFragment: function() {
			...
			if (!this._DetalhesPesagemFragment) {
				this._DetalhesPesagemFragment = sap.ui.xmlfragment("DetalhesPesagem",
					"sap.agro.gestaoprocessos.view.RecebimentoCana.Compartimento.fragments.DetalhesPesagem",
					this
				);
